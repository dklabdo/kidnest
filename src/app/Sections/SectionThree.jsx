...
function SectionThree() {
  return (
    <div  id='service' className='w-full my-20 xl:my-40 '>
        ...
        <div className='flex flex-col gap-20  xl:flex-row my-28 px-8 md:px-28 xs:px-2 xl:px-24 xl:justify-center  xl:gap-10'>
...
function Card({icon,title,content} ){
    return(
        <div  className='w-full  xl:w-[500px] bg-white shadow-lg px-4 py-20 rounded-3xl flex flex-col gap-6 shadow-gray-400/80'>
            <div className={`flex justify-center mx-auto items-center w-28 h-28 my-4 rounded-full ${icon == 2 ? "bg-secondary/70" : "bg-primary/70"}`}>
